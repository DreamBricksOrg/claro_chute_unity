...
public class TargetElement : MonoBehaviour, IElementState
{
    ...
    void Awake()
    {
        stageTransform.transform.localPosition = new Vector3(0, -3, 0);
    }
    ...
    public void OnBegin()
    {
        entityData = StorageController.Instance.GetRandomEntity();
    ...
    public void OnPrepare()
    {
        ...
        stageTransform.DOLocalMoveY(0, animTime)
    ...
    public void OnReset()
    {
        ...
        stageTransform.DOKill();
        stageTransform.DOLocalMoveY(-3, animTime)
